...
一键安装：
```shell
bash <(wget --no-check-certificate -qO- 'https://raw.githubusercontent.com/54020010/ELM/main/images/docker_create.sh')
```
狗东面板docker

一键安装：
```shell
bash <(wget --no-check-certificate -qO- 'https://raw.githubusercontent.com/54020010/ELM/main/JD/docker_create.sh')
```
#### 本仓库之中所有脚本以及配置纯属自用备份
## 免责声明
